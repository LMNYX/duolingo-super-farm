...
const duolingoWs = new WebSocket('ws://localhost:9891');
...
export default class Worker
{
    ...
    async #HandleTask(task, taskCount, retryCount)
    {
        ...
        try
        {
            const _context = await this.browser.createIncognitoBrowserContext();
            const _tasks = task.tasks;
            this.pages.push({"context": _context, "page": await _context.newPage(), "stored_vdata": [], "stored_kwdata": {}});
